...
export interface SendToYupaSuccessNotificationData extends baseNotificationData {
    invoiceHash: string;
    invoiceRequest: string;
    invoiceAmountSat: number;
}
...
export interface ReceiveFromYupaSuccessNotificationData extends baseNotificationData {
    invoiceHash: string;
    invoiceRequest: string;
    invoiceAmountSat: number;
}
export interface ReceiveFromYupaFailedNotificationData extends baseNotificationData {
    invoiceHash: string;
    invoiceRequest: string;
    invoiceAmountSat: number;
    failedReason: string;
